...
const CH_OPTIONS: Record<string, string[]> = {
  notoriedad: ['Meta Ads Branding','TikTok Ads Branding','LinkedIn Ads Branding','YouTube Branding','Display Branding','Influencer Paid','Influencer Envio Producto','Brand Ambassadors','Employer Branding','Employee Advocacy','Ponencias en Eventos','Contenidos Medios Pagados','Colaboracion con Medios','Branded Content','Sponsorship','Podcast Propio','Blog / Vblog','Contenidos RRSS','Boca a Oreja','Premios','Brand Days','Exterior','Prensa y Revistas','Radio','TV','Cine'],
  interaccion: ['LinkedIn Empresa','LinkedIn Perfiles Personales','LinkedIn Groups','Webinars','Workshops','Contenidos Formativos','Eventos Propios','Google Business','Live Streaming','Referencias Online','Web Corporativa','Concursos','Acudir a Eventos','Comunidad Propia','Networking','WhatsApp Business','Bot IA','Demos','Casos de Exito','Propuestas Interactivas','Soporte Humano','Call Center','Banners Interactivos','Slideshare','Puntos de Venta','Flyers','Seeding','Internet of Things'],
  lead_venta: ['SEO','ASO','Link Building','SEM / Buscadores','LLM Ads','Meta Ads Performance','TikTok Performance','LinkedIn Performance','Display Retargeting','Display Performance','Email BBDD Propia','Email Automation','Newsletters','Alquiler de BBDD','Cold Outreach','Social Selling','Marketing de Afiliacion','Member Get Member','SMS','Influencer Performance','Lead Magnets','Cupones','Landing de Venta','Workshops Lead','Eventos Online','Eventos Presenciales','Punto de Venta','Merchandising'],
  fidelizacion: ['Email Automation CRM','WhatsApp Fidelizacion','Programa Fidelizacion','Push Notifications','SMS Fidelizacion','Reviews / Reputacion','Comunidad Propia','Customer Success','NPS y Feedback','Contenido Exclusivo'],
}
...
function WizardInner() {
  ...
  function markDone(s:number) { setErr(""); setPlan(p=>({...p,completed:p.completed.includes(s)?p.completed:[...p.completed,s]})) }
        ...
        <div style={{ maxWidth:1040, margin:'0 auto', padding:'40px 24px 80px' }}>
          ...
          {step===1&&plan.entorno&&(
            <div>
              ...
              <div style={CARD}>
                <h2 style={{ fontSize:18, fontWeight:600, color:C.navy, marginBottom:14 }}>DAFO</h2>
