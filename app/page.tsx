    ...
    plans: [
      {
        ...
        features: ['1 plan completo con IA','5 fases del Canvas','10 mejoras con IA','Vídeos formativos incluidos','Export PDF básico con marca de agua'],
      ...
      },
      {
        ...
        features: ['10 planes/mes con IA completa','70 mejoras con IA/mes','20 análisis con IA/mes','Vídeos formativos completos','Calculadora táctica avanzada','Export PDF sin marca de agua','Planes guardados','Soporte prioritario'],
        missing: [],
      ...
      },
      {
        ...
        features: ['30 planes/mes con IA completa','150 mejoras con IA/mes','60 análisis con IA/mes','Todo lo de Pro','Sin marca de agua','Soporte chat con IA','Créditos acumulables 3 meses','Hasta 5 usuarios','Onboarding personalizado'],
        missing: [],
      ...
      },
      {
        ...
        features: ['Planes y mejoras ilimitados','Todo lo de Business','Hasta 10 usuarios','Whitelabel — tu marca','SLA garantizado','Factura B2B / prepago','Acceso API (próximamente)'],
        missing: [],
