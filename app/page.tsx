    ...
    plans: [
      {
        ...
        features: ['1 plan completo con IA','5 fases del Canvas','10 repensares de campos','Vídeos formativos incluidos','Export PDF básico con marca de agua'],
      ...
      },
      {
        ...
        features: ['10 planes/mes con IA completa','70 repensares de campos/mes','20 ideas con IA/mes','Vídeos formativos completos','Calculadora táctica avanzada','Export PDF sin marca de agua','Planes guardados','Soporte prioritario'],
        missing: [],
        cta: '7 días gratis', hilight: true, note: 'Luego €15/mes · Cancela cuando quieras',
      },
      {
        name: 'Business', badge: '', monthly: '€35', annual: '€300', per: '/mes',
        desc: 'Para agencias y equipos',
        features: ['30 planes/mes con IA completa','150 repensares de campos/mes','60 ideas con IA/mes','Todo lo de Pro','Sin marca de agua','Soporte chat con IA','Créditos acumulables 3 meses','Hasta 5 usuarios','Onboarding personalizado'],
        missing: [],
      ...
      },
      {
        ...
        features: ['Planes y repensares ilimitados','Todo lo de Business','Hasta 10 usuarios','Whitelabel — tu marca','SLA garantizado','Factura B2B / prepago','Acceso API (próximamente)'],
        missing: [],
